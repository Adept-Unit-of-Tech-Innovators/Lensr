...
public class BrickwallFilter extends Line implements Editable, Serializable {
    ...
    @Override
    public void delete() {
        LensrStart.peakTransmissionSlider.hide();
        LensrStart.startPassbandSlider.hide();
        LensrStart.endPassbandSlider.hide();
        graph.clear();
        graph.hide();
    ...
    public void openObjectEdit() {
        // Setup sliders
        LensrStart.peakTransmissionSlider.setCurrentSource(this);
        LensrStart.startPassbandSlider.setCurrentSource(this);
        LensrStart.endPassbandSlider.setCurrentSource(this);
        LensrStart.peakTransmissionSlider.show();
        LensrStart.startPassbandSlider.show();
        LensrStart.endPassbandSlider.show();
