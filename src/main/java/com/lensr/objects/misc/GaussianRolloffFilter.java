...
public class GaussianRolloffFilter extends Line implements Editable, Serializable {
    ...
    @Override
    public void delete() {
        LensrStart.passbandSlider.hide();
        LensrStart.peakTransmissionSlider.hide();
        LensrStart.FWHMSlider.hide();
        graph.hide();
    ...
    public void openObjectEdit() {
        ...
        LensrStart.passbandSlider.setCurrentSource(this);
        LensrStart.FWHMSlider.setCurrentSource(this);
        LensrStart.peakTransmissionSlider.show();
        LensrStart.passbandSlider.show();
        LensrStart.FWHMSlider.show();
